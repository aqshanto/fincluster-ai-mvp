...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-slate-800/70">
      ...
      <div className="relative mx-auto grid min-h-190 max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1.04fr_0.96fr] lg:px-8 lg:py-24">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
            ...
            intelligent scheduler that classifies transaction workloads, checks
            node health, handles anomalies, and sends uncertain decisions to a
            human operator before execution.
          </p>
        ...
        <div className="relative mx-auto w-full max-w-xl">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-slate-700/80 bg-slate-950/90 p-5 shadow-2xl shadow-blue-950/40">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-slate-400">
                    The transaction is not routed until an operator confirms the
                    correct processing workload.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 flex items-center justify-between rounded-xl border border-slate-800 bg-slate-900/70 px-4 py-3">
