import { ArrowRight, BadgeCheck, BrainCircuit, Database, PauseCircle, UserCheck } from "lucide-react";
    ...
    <section className="border-b border-slate-800/70 py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          description={
            <p>
              A model with 87% accuracy cannot identify its own incorrect 13%
              at prediction time. FinCluster therefore marks uncertain cases as
              <strong className="font-bold text-amber-200"> pending review</strong>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-rose-500/20 bg-rose-500/5 p-5">
            ...
            <ul className="mt-4 space-y-2 text-sm text-slate-400">
              <li>• It does not label uncertain predictions as known failures.</li>
              <li>• It does not retrain from its own unverified guesses.</li>
              <li>• It does not route a held transaction before operator review.</li>
              <li>• It does not promote a candidate that fails quality gates.</li>
            </ul>
          </div>
        </div>
      </div>
