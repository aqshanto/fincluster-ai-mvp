...
const baseButton =
  "flex h-10 shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-lg border px-3 py-1.5 text-[11px] font-semibold transition-all sm:text-xs";
...
export default function ControlPanel({
  ...
  return (
    <>
      <footer className="glass-panel pointer-events-auto relative z-20 border-t border-slate-800/80 px-3 py-2">
        <div className="mx-auto w-full max-w-350 overflow-x-auto">
          <div className="flex w-max min-w-full items-center justify-center gap-2 px-1 pb-1">
            <button
              type="button"
              onClick={() =>
                void requireOperator(() =>
                  api.post("/api/v1/control/toggle-ai"),
                )
              }
              className={`${baseButton} px-4 shadow-lg ${
                aiEnabled
